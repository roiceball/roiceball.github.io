  ...
  display : function() {
    ...
    if((!mousePress) || this.falls) {
      push();
        ...
        // image(sprite_flappy, 0, 0, sprite_flappy.width, sprite_flappy.height);
      pop();
    }
    else {
      push();
...
function setup() {
  ...
  //load
  sprite_flappy = loadImage('sprites/flappybird.png');
  sprite_pipe = loadImage('sprites/pipe.png');
  sprite_city = loadImage('sprites/city.png');
  sprite_floor = loadImage('sprites/floor.png');
  // sprite_title = loadImage('sprites/title.png');
  
  sound_point = loadSound('audio/point.wav');
  sound_hit = loadSound('audio/hit.wav');
  sound_die = loadSound('audio/die.wav');
  //sound_wing = loadSound('http://flappybird.netlify.com/data/Assets/sound/sfx_wing.wav');
  sound_wing = loadSound('audio/wing.wav');
  sound_sweetwing = loadSound('audio/swooshing.wav');
...
function page_game() {
  ...
  image(sprite_floor, sprite_floor.width - overflowX, height - sprite_floor.height / 10, sprite_floor.width, sprite_floor.height);
image(sprite_floor, sprite_floor.width + sprite_floor.width - overflowX, height - sprite_floor.height / 10, sprite_floor.width, sprite_floor.height);
image(sprite_floor, sprite_floor.width + sprite_floor.width * 2 - overflowX, height - sprite_floor.height / 10, sprite_floor.width, sprite_floor.height);
...
function page_menu() {
  ...
  push();
    ...
    stroke(83,56,71);
    fill(255);
    text('Enactus Crane',width/2,100);
  pop();
